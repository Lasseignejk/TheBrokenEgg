				...
				<div className="w-full flex md:items-center md:justify-center">
					<div className="flex flex-col px-3 justify-center items-center gap-5 sm:w-3/4 lg:w-1/2">
						...
						<div className="flex gap-10">
							<Link to={"https://github.com/Lasseignejk"}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 496 512"
									className="w-[50px] h-[50px] hover:scale-125 duration-200 ease-in">
							...
							<Link to={"https://www.linkedin.com/in/jayelon-lasseigne/"}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 448 512"
									className="w-[50px] h-[50px] hover:scale-125 duration-200 ease-in">
							...
							<Link to={"https://medium.com/@jayelonlasseigne"}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 640 512"
									className="w-[50px] h-[50px] hover:scale-125 duration-200 ease-in">
