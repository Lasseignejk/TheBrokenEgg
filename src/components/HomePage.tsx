	...
	return (
		<div className="">
			<div className=" min-h-[calc(100vh-14.3rem)] lg:grid  lg:grid-cols-homelg xl:grid-cols-homexl">
				<LeftImage />
				<div className="w-full flex flex-col justify-center items-center md:justify-start gap-5">
					...
					<div className="bg-mobileBanner bg-contain h-40 w-full md:bg-none">
						<div className="flex flex-col justify-center items-center bg-overlay py-3 h-40 md:bg-background">
							<h1 className="text-2xl text-center font-italic font-grandStand font-bold px-3 leading-relaxed">
								Click{" "}
								<Link
									to={"/search"}
									className="hover:text-main ease-in duration-200">
									here
								</Link>{" "}
								to browse all of our recipes
							</h1>
						</div>
					</div>
				</div>
